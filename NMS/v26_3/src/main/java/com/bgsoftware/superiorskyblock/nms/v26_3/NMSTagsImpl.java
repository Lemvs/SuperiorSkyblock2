...
public class NMSTagsImpl extends com.bgsoftware.superiorskyblock.nms.v26_3.AbstractNMSTags {
    ...
    public org.bukkit.inventory.ItemStack getSkullWithTexture(org.bukkit.inventory.ItemStack bukkitItem, String texture) {
        ...
        return NMSUtilsVersioned.asMirror(itemStack);
    }
    ...
    protected CompoundTag setTagAndGetCompoundTag(ItemStack itemStack, String key, int value) {
        ...
        tagCompound.putInt("DataVersion", com.bgsoftware.superiorskyblock.nms.v26_3.AbstractNMSAlgorithms.DATA_VERSION);
